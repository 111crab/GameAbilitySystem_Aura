...
- 准许做轻量资产盘点；具体技能需要哪些资产，仍等正式写具体技能时再确认。
...
- 正式代码必须有学习型注释，并配套中文说明文档。

## 当前推荐路线

1. Phase 1 已收束：技能机制大类、代表技能池、V1-A 技能顺序已经确认。
2. Phase 2 架构方向已确认：克制版方案 C。
3. 下一步编写 `Agent/02_SkillSystem/Skill_Runtime_Model.md`。
4. 运行时模型确认后做轻量资产盘点，再写第一份 Claude 实施 Prompt。
